...
class image_converter:
    def __init__(self):    
        ...
        self.image_pub = rospy.Publisher("object_delect_image", Image, queue_size = 0)
        self.target_pub = rospy.Publisher("object_delect_pose", Pose, queue_size = 0)
    ...
    def callback(self,data):
        ...
        for c in cnts:
            ...
            if int(M["m00"]) not in range(20000, 150000):
                continue
